...
public class Film extends TableImpl<FilmRecord> {
    ...
    private static final long serialVersionUID = -1298544615;
     ...
     */
    public final TableField<FilmRecord, MpaaRating> RATING = createField("rating", org.jooq.util.postgres.PostgresDataType.VARCHAR.asEnumDataType(com.dvdstore.model.enums.MpaaRating.class), this, "");
